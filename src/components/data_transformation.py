...
class DataTransformationConfig:
    preprocessor_obj_file_path=os.path.dirname('artifacts','preprocessor.pkl')
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_data_path,test_data_path):
        ...
        try:
            ...
            ## Segregating the dataset into independent and dependent features
            ...
            logging.info('Applying preprocessing objects on training and test datasets')
